...
Your can interact with the shiny app [here.](https://lucas-okwudishu.shinyapps.io/shelter_occupancy_prediction_app/)
:::
...
1. **Accuracy Tracking**:
    ...
    include statistical measures as MAE, RMSE to compute accuracy of predictions in production.
